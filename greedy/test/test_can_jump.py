...
from greedy.JumpGame import can_jump
...
class MyTestCase(unittest.TestCase):
    ...
    def test_can_jump_2(self):
        self.assertEqual(True, can_jump(self, [2, 0]))

    def test_can_jump_3(self):
        self.assertEqual(True, can_jump(self, [2, 5, 0, 0]))

    def test_can_jump_4(self):
        self.assertEqual(True, can_jump(self, [3, 0, 8, 2, 0, 0, 1]))
