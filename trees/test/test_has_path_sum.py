...
from trees.PathSum import has_path_sum_dfs, has_path_sum_rec
...
class MyTestCase(unittest.TestCase):
    def test_has_path_sum(self):
        ...
        self.assertEqual(True, has_path_sum_rec(self, root, 22))
    ...
    def test_has_path_sum_1(self):
        ...
        self.assertEqual(False, has_path_sum_rec(self, root, 5))
