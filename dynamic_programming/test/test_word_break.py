...
from dynamic_programming.WordBreak import word_break, word_break_constant, word_break_top_down
...
class MyTestCase(unittest.TestCase):
    ...
    def test_word_break_constant(self):
        ...
        self.assertEqual(True, word_break_top_down(self, "leetcode", ["leet", "code"]))
    ...
    def test_word_break_constant_1(self):
        ...
        self.assertEqual(True, word_break_top_down(self, "applepenapple", ["apple", "pen"]))
    ...
    def test_word_break_constant_2(self):
        ...
        self.assertEqual(False, word_break_top_down(self, "catsandog", ["cats", "dog", "sand", "and", "cat"]))
