...
from dynamic_programming.UniqueBinarySearchTrees import num_trees_top_down, num_trees_bottom_up, \
    num_trees_catalan_numbers, num_trees_catalan_numbers_2
...
class MyTestCase(unittest.TestCase):
    def test_num_trees(self):
        ...
        self.assertEqual(5, num_trees_catalan_numbers_2(self, 3))
    ...
    def test_num_trees_1(self):
        ...
        self.assertEqual(1, num_trees_catalan_numbers_2(self, 1))
