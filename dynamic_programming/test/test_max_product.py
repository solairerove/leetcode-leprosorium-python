...
class MyTestCase(unittest.TestCase):
    ...
    def test_max_product_from_smarter_guy(self):
        self.assertEqual(6, max_product_from_smarter_guy(self, [2, 3, -2, 4]))  # add assertion here

    def test_max_product_from_smarter_guy_1(self):
        self.assertEqual(0, max_product_from_smarter_guy(self, [-2, 0, -1]))  # add assertion here
