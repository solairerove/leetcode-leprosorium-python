...
from graphs.NumberOfOperationsToMakeNetworkConnected import make_connected_dfs, make_connected_bfs, make_connected_union
...
class MyTestCase(unittest.TestCase):
    def test_make_connected(self):
        ...
        self.assertEqual(1, make_connected_union(self, 4, [[0, 1], [0, 2], [1, 2]]))
    ...
    def test_make_connected_1(self):
        ...
        self.assertEqual(2, make_connected_union(self, 6, [[0, 1], [0, 2], [0, 3], [1, 2], [1, 3]]))
    ...
    def test_make_connected_2(self):
        ...
        self.assertEqual(-1, make_connected_union(self, 6, [[0, 1], [0, 2], [0, 3], [1, 2]]))
