...
from graphs.MinimumNumberOfVerticesToReachAllNodes import find_smallest_set_of_vertices_bfs, \
    find_smallest_set_of_vertices_dfs
...
class MyTestCase(unittest.TestCase):
    ...
    def test_find_smallest_set_of_vertices_1(self):
        self.assertEqual([0, 2, 3],
                         find_smallest_set_of_vertices_dfs(self, 5, [[0, 1], [2, 1], [3, 1], [1, 4], [2, 4]]))
        self.assertEqual([0, 2, 3],
                         find_smallest_set_of_vertices_bfs(self, 5, [[0, 1], [2, 1], [3, 1], [1, 4], [2, 4]]))
