...
from linked_list.InsertionSortList import insertion_sort_list
...
class MyTestCase(unittest.TestCase):
    ...
    def test_insertion_sort_list_2(self):
    ...
    def test_insertion_sort_list_3(self):
    ...
    def test_insertion_sort_list_4(self):
    ...
    def test_insertion_sort_list_5(self):
