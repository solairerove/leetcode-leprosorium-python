...
from arrays.MeetingRooms import can_attend_meetings, can_attend_meetings_short, can_attend_meetings_short_1
...
class MyTestCase(unittest.TestCase):
    def test_can_attend_meetings(self):
        ...
        self.assertEqual(False, can_attend_meetings_short_1(self, [[0, 30], [5, 10], [15, 20]]))
    ...
    def test_can_attend_meetings_1(self):
        ...
        self.assertEqual(True, can_attend_meetings_short_1(self, [[7, 10], [2, 4]]))
